...
cv = Tools("Kin Lon Choi", "https://github.com/KinLonChoi")
...
team = dict.fromkeys(['team', 'independent'],
...
plan = dict.fromkeys(['innovat', 'improve', 'projects'],
